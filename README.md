...
# 📖 [Leaderboard Application] <a name="about-project">
  This website is viewing the score board and we can add our score with name.
</a>
...
```bash git clone https://github.com/Mahdi-Niazi/leaderboard-project.git ``` 
1. To access cloned directory run: 
```bash cd leaderboard-project ``` 
