 ...
 */
(self["webpackChunkwebpack_practice"] = self["webpackChunkwebpack_practice"] || []).push([["main"],{
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _variable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variable.js */ \"./src/variable.js\");\n\n\n_variable_js__WEBPACK_IMPORTED_MODULE_0__.showData.addEventListener('click', (e) => {\n  e.preventDefault();\n\n  _variable_js__WEBPACK_IMPORTED_MODULE_0__.table.innerHTML = '';\n  async function showScore() {\n    const show = await fetch(_variable_js__WEBPACK_IMPORTED_MODULE_0__.apiURL);\n    return show.json();\n  }\n  showScore().then((data) => {\n    data.result.forEach((user) => {\n      const markup = `<tr> <td> ${user.user} : ${user.score}</td></tr> `;\n      _variable_js__WEBPACK_IMPORTED_MODULE_0__.table.innerHTML += markup;\n    });\n  });\n});\n\n\n//# sourceURL=webpack://webpack-practice/./src/ShowScore.js?");
...
eval("fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games', {\n  method: 'POST',\n  headers: {\n    'Content-Type': 'application/json',\n  },\n  body: JSON.stringify({\n    name: 'Cheese',\n  }),\n}).then((response) => response.json());\n\n\n//# sourceURL=webpack://webpack-practice/./src/addGame.js?");
